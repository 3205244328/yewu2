...
const device = iot.device({
  productKey: 'a1XCumFbQrL', //将<productKey>修改为实际产品的ProductKey
  deviceName: 'Feng',//将<deviceName>修改为实际设备的DeviceName
  deviceSecret: 'ace06d5320fa785d3acc0683a6b86163',//将<deviceSecret>修改为实际设备的DeviceSecret
})
device.on('connect', () => {
  //将<productKey> <deviceName>修改为实际值
  device.subscribe('/a1XCumFbQrL/Feng/user/get');
  console.log('connect successfully!');
  //发送消息给谁
  device.publish('/a1XCumFbQrL/Feng/user/update', 'hello world!');
});
