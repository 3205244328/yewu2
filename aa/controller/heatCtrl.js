...
const device = iot.device({
  productKey: 'a1IiABXMdem', //将<productKey>修改为实际产品的ProductKey
  deviceName: 'fire',//将<deviceName>修改为实际设备的DeviceName
  deviceSecret: '9d0277fced4cfe14dde0fd075819975b',//将<deviceSecret>修改为实际设备的DeviceSecret
})
device.on('connect', () => {
  //将<productKey> <deviceName>修改为实际值
  device.subscribe('/a1IiABXMdem/fire/user/get');
  console.log('connect successfully!');
  //发送消息给谁
  device.publish('/a1IiABXMdem/fire/user/update', 'hello world!');
});
