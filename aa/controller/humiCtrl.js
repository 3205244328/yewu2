...
const device = iot.device({
  productKey: 'a1Bn75TsD1d', //将<productKey>修改为实际产品的ProductKey
  deviceName: 'jiashi',//将<deviceName>修改为实际设备的DeviceName
  deviceSecret: '53e6cee14859f5aeae890f0d3eb0cfb4',//将<deviceSecret>修改为实际设备的DeviceSecret
})
device.on('connect', () => {
  //将<productKey> <deviceName>修改为实际值
  device.subscribe('/a1Bn75TsD1d/jiashi/user/get');
  console.log('connect successfully!');
  //发送消息给谁
  device.publish('/a1Bn75TsD1d/jiashi/user/update', 'hello world!');
});
